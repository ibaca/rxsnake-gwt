...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.rxsnake=");
    idx += (13 + "rxsnake".length);  // 
  }
  if (idx >= 0) {
